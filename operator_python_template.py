...
Version 3.0.0 adds Vec-safe default paths, reusable Halcyon palette tokens,
and a few extra validation helpers for time-series/log work.
...
Examples:
    ...
    python3 operator_python_template.py --input data.csv --x-column time_s --y-columns command response raw_signal
